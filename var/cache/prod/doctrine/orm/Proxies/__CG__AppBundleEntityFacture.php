...
class Facture extends \AppBundle\Entity\Facture implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Facture' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Facture' . "\0" . 'number', '' . "\0" . 'AppBundle\\Entity\\Facture' . "\0" . 'price', '' . "\0" . 'AppBundle\\Entity\\Facture' . "\0" . 'customer', '' . "\0" . 'AppBundle\\Entity\\Facture' . "\0" . 'tickets'];
        }
